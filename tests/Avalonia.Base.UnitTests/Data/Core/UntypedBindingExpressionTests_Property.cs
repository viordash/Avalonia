...
namespace Avalonia.Base.UnitTests.Data.Core
{
    public class UntypedBindingExpressionTests_Property
    {
        ...
        ////{
        ////    var target = UntypedBindingExpression.Create(Observable.Return(default(Class3)), o => o.Foo);
        ////    var result = await target.Take(1);
        ...
        ////{
        ////    var target = UntypedBindingExpression.Create<object, string>(Observable.Return(AvaloniaProperty.UnsetValue), o => (o as Class3).Foo);
        ////    var result = await target.Take(1);
        ...
        ////    var target = UntypedBindingExpression.Create(() => data.Foo, o => o, update);
        ////    var result = new List<object>();
        ...
        ////    var root = first;
        ////    var update = new Subject<ValueTuple>();
        ////    var target = UntypedBindingExpression.Create(() => root, o => o.Foo, update);
        ////    var result = new List<object>();
        ////    var sub = target.Subscribe(x => result.Add(x));
        ...
        ////{
        ////    var data = "foo";
        ////    var target = new UntypedBindingExpression(() => data, new EmptyExpressionNode(), new Subject<ValueTuple>(), null);
        ////    var result = new List<object>();
        ////    var sub = target.Subscribe(x => result.Add(x));
